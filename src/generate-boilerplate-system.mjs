...
class SystemGenerator {
    ...
    cleanPackageJson() {
        ...
        const npmLockFile = `build/${this.packageName}/package-lock.json`;
        const pnpmLockFile = `build/${this.packageName}/pnpm-lock.yaml`;

        [npmLockFile, pnpmLockFile].forEach(file => {
